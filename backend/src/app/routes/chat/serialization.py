...
def guess_agent_from_namespace(namespace: Any) -> Optional[str]:
    canonical_by_key = {
        ...
        # Legacy aliases for backwards compatibility with existing thread history.
        "devil's advocate": "Product Strategist",
        "devils_advocate": "Product Strategist",
        "devils advocate": "Product Strategist",
        "angel eyes": "Growth Lead",
        "angel_eyes": "Growth Lead",
        "capital freak": "Business Lead",
        "capital_freak": "Business Lead",
        "cake man": "Product Strategist",
        "cake_man": "Product Strategist",
        "buzz": "Growth Lead",
        "mr. t": "Technical Lead",
        "mr_t": "Technical Lead",
    }
