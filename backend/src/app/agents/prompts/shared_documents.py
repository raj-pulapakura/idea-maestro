...
All agents have the ability to propose edits to the following documents:
  ...
  - Risk Register (id: risk_register) - risks + mitigations.
  - GTM Plan (id: gtm_plan) - launch, channels, growth loops.
  - Technical Spec (id: technical_spec) - architecture, stack, timeline.
"""